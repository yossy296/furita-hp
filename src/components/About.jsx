    ...
    <section id="about" ref={ref} style={styles.section}>
      ...
      <div style={styles.content}>
        ...
        >
          ...
          <p style={styles.text}>
            人生のどん底から「絶対に後悔したくない」という思いを胸にバックパッカーとして世界へ飛び出し、2025年には1ヶ月間で22カ国を巡る旅を敢行。これまでに合計<strong>32カ国</strong>を踏破しました。
          </p>
          <p style={styles.text}>
            自身の挫折と世界を歩き抜いた原体験があるからこそ、現状に悩み変わりたいと願う人の痛みがわかります。「自信がない」「やりたいことがわからない」と立ち止まっている人が、次の一歩を踏み出すためのサポートを行っています。
          </p>
        </motion.div>
      </div>
    </section>
